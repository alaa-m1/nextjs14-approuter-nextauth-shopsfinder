...
@media screen and (max-width:384px) {.mail-message-content { width:414px!important } }
 ...
 <body style="width:100%;font-family:Lexend, Arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
  <div dir="ltr" class="es-wrapper-color" lang="en" style="background-color:#F6F5F5"><!--[if gte mso 9]>
			<v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t">
				<v:fill type="tile" color="#f6f5f5"></v:fill>
			</v:background>
		<![endif]-->
   <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#F6F5F5">
     <tr>
       ...
       <table class="es-header" cellspacing="0" cellpadding="0" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:transparent;background-repeat:repeat;background-position:center top">
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table class="es-header-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#2C2C2C;width:600px">
             <tr>
              <td align="left" bgcolor="#e1f0fb" style="padding:30px;Margin:0;background-color:#e1f0fb">
                 ...
                 <tr>
                  <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:540px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;font-size:0px"><img src="https://mafkgq.stripocdn.email/content/guids/CABINET_610a88236818908a0613d50ee3b877f23c9809029cb0c0287e8736422edea39a/images/phoenix_shops_finder.png" alt="Logo" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" title="Logo" width="252" class="adapt-img"></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
         ...
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
               ...
               <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td class="es-m-p0r es-m-p20b" valign="top" align="center" style="padding:0;Margin:0;width:600px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="https://mafkgq.stripocdn.email/content/guids/CABINET_610a88236818908a0613d50ee3b877f23c9809029cb0c0287e8736422edea39a/images/shopsfinder.png" alt="Payment Details Update Required" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="600" title="Payment Details Update Required"></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
             ...
             <tr>
              <td align="left" bgcolor="#e1f0fb" style="Margin:0;padding-top:30px;padding-left:30px;padding-right:30px;padding-bottom:40px;background-color:#e1f0fb">
         ...
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table class="es-footer-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#939393;width:600px">
             <tr>
              <td align="left" bgcolor="#ecebeb" style="Margin:0;padding-left:30px;padding-right:30px;padding-top:35px;padding-bottom:35px;background-color:#ecebeb"><!--[if mso]><table style="width:540px" cellpadding="0" cellspacing="0"><tr><td style="width:235px" valign="top"><![endif]-->
               ...
               <table cellpadding="0" cellspacing="0" class="es-right" align="right" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:285px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-bottom:5px"><h1 style="text-align:center;Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:georgia, times, 'times new roman', serif;font-size:28px;font-style:normal;font-weight:normal;color:#2C2C2C">Follow Me</h1></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:5px;Margin:0"><!--[if mso]><a href="https://www.linkedin.com/in/alaa-mohammad-767622199/" target="_blank" hidden>
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://www.linkedin.com/in/alaa-mohammad-767622199/" 
                style="height:41px; v-text-anchor:middle; width:275px" arcsize="50%" stroke="f"  fillcolor="#0a66c2">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:Lexend, Arial, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>LinkedIn</center>
	</v:roundrect></a>
<![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border" style="width:100% !important;border-style:solid;border-color:#2CB543;background:#0a66c2;border-width:0px;display:block;border-radius:30px;width:auto;mso-hide:all"><a href="https://www.linkedin.com/in/alaa-mohammad-767622199/" class="es-button msohide es-button-1706208036121" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#ffffff;font-size:18px;display:block;background:#0a66c2;border-radius:30px;font-family:Lexend, Arial, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;padding:10px 5px;mso-padding-alt:0;mso-border-alt:10px solid #0a66c2;mso-hide:all">LinkedIn</a></span><!--<![endif]--></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:5px;Margin:0"><!--[if mso]><a href="https://www.xing.com/profile/alaa_mohammad8/cv" target="_blank" hidden>
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://www.xing.com/profile/alaa_mohammad8/cv" 
                style="height:41px; v-text-anchor:middle; width:275px" arcsize="50%" stroke="f"  fillcolor="#cfdc00">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:Lexend, Arial, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Xing</center>
	</v:roundrect></a>
<![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border" style="width:100% !important;border-style:solid;border-color:#2CB543;background:#cfdc00;border-width:0px;display:block;border-radius:30px;width:auto;mso-hide:all"><a href="https://www.xing.com/profile/alaa_mohammad8/cv" class="es-button msohide" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#ffffff;font-size:18px;display:block;background:#cfdc00;border-radius:30px;font-family:Lexend, Arial, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;padding:10px 30px 10px 30px;mso-padding-alt:0;mso-border-alt:10px solid #cfdc00;mso-hide:all;padding-left:5px;padding-right:5px">Xing</a></span><!--<![endif]--></td>
                     </tr>
                   </table></td>
                 </tr>
